...
public class RadarCustomView extends View {
    ...
    public RadarCustomView(Context context) {
        this(context, null);
    }


    public RadarCustomView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RadarCustomView(Context context, AttributeSet attrs, int defStyleAttr) {
